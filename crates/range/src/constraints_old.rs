...
impl ConstraintSystem {
    ...
    pub fn new(generators: &GeneratorSet, bit_length: usize) -> Self {
        ...
        let g_generators = generators.g_generators(required_generators);
        let h_generators = generators.h_generators(required_generators);
        
        Self {
            g_generators,
            h_generators,
            u_generator: generators.u_generator(),
            bit_length,
        }
    }
